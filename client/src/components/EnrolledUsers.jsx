...
const EnrolledUsers = ({ players }) => {
  ...
  return (
    <div className="w-full rounded-[10px] bg-white overflow-hidden shadow-sm mt-2">
      <h3 className="text-lg text-start font-bold bg-light-main-blue text-white  px-4 flex justify-between items-center">Enrolled Users <span className="">{players.length}</span></h3>
