  ...
  return (
    <div className="mt-4 w-full rounded-[20px] bg-slate-100/10 backdrop-blur-lg shadow-lg text-light-brown-03 font-dynapuff overflow-x-auto">
      <table className="w-full text-center border-collapse">
        <thead className=''>
          <tr className="bg-gradient-to-r from-[#677AE3] via-[#6D65C8] to-[#7551A9]  text-slate-200 text-[16px] rounded-[20px] overflow-hidden">
            ...
            <th className="px-4 py-3 text-center border-b border-slate-200/30">L</th>
            <th className="px-4 py-3 text-center border-b border-slate-200/30">D</th>
            <th className="pr-6 py-3 text-center border-b border-slate-200/30">Points</th>
          </tr>
        </thead>
        <tbody>
