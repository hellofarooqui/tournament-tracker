    ...
    >
      ...
      <div className="p-4 grid grid-cols-[40%_auto_40%] w-full items-center">
        <div className="flex flex-col gap-y-2 justify-center items-center">
            <div className="rounded-md bg-emerald-300/30 w-16 h-16 flex justify-center items-center">
      ...
      <p className="text-sm text-center font-thin p-1 bg-slate-200/30 text-gray-200/70">
