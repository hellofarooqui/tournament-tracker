        ...
        <div>
          ...
          >
              ...
              <div className="w-full flex gap-x-4 text-xl  text-white mt-2">
                <button type="submit" className="flex-1 bg-gradient-to-r from-[#0AC2F8] to-[#3385D9] py-2 rounded-[10px]">Login</button>
                <p  onClick={()=>navigate('/register')} className="text-center flex-1  bg-gradient-to-r from-[#FD6861] to-[#F05C2E] py-2 rounded-[10px]">Signup</p>

              </div>
          </form>
        </div>
         <Link to='/'><p className="text-sm text-slate-200/70 font-thin italic text-center underline">Go Back to Home</p></Link>
      </div>
