...
const Home = () => {
  return (
    <div className='w-full h-screen flex items-center justify-center py-16'>
      <div className='flex flex-col gap-y-4 text-xl font-semibold text-yellow-01'>
        ...
        <Link to='view-all' className='bg-purple-02 p-2 rounded-[10px] px-8 py-4 text-center'>View Tournaments</Link>
